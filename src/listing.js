const ListingData = [
  {
    ...
    price: 254950,
    description:
      "HELP TO BUY AVAILABLE! Move into your new apartment in Q1 2019!",
    features: [
  ...
  },
  {
    ...
    price: 3500000,
    description:
      "A rare opportunity to purchase a superb four bedroom, custom designed triplex apartment set on floors 44, 45 and 46 of Manchesters most iconic building, The Beetham Tower.",
    features: [
      "Triplex penthouse",
      "Five parking spaces",
      "Home cinema",
  ...
  },
  {
    ...
    price: 2000000,
    description:
      "The Penthouse 360 Building. Total floor area of approximately 4780 Sq. Ft. A labour of love, a vision of creating arguably one of the best living spaces with no expense spared in the city centre.",
    features: [
      "The Penthouse 360",
  ...
  },
  {
    ...
    price: 2000000,
    description:
      "We're delighted to present this exceptional four bedroom penthouse apartment on the top floor of the highly sought-after and only residential block on Spinningfields.",
    features: [
  ...
  },
  {
    ...
    price: 1075034,
    description:
      "Located in the heart of Manchester Oxygen is the City's most 'EXCLUSIVE' five star LEISURE FACILITIES and SKY GARDENS. Oxygen will be a beacon of Manchester's skyline featuring 343 STYLISH apartments, 12 townhouses.",
    features: [
      "7% Rental yields",
